...
export const SeasonNavData = [
  ...
  {
    title: 'winter',
    h2Title: '와 함께 12월의 설렘을',
    text: '따뜻한 집콕, 겨울 힐링 무비 ❄️',
    startDate: '12-01',
    endDate: '12-14',
    type: 'keyword',
  },
  // 2. 연말연시
  {
    ...
    text: '함께 즐겨요, 가족 파티 영화 🥂 ',
    keywordId: '378,1009,2600',
    startDate: '12-15',
    endDate: '12-31',
    type: 'keyword',
  },
  ...
  {
    title: 'newYear',
    h2Title: '와 함께 새로운 도전 시작!',
    text: '새해 다짐! 목표 달성 동기 부여 💪 ',
    keywordId: '435,10385,2325',
    startDate: '01-01',
    endDate: '01-10',
    type: 'keyword',
  },
  ...
  {
    title: 'winter',
    h2Title: '와 함께 따뜻한 실내 데이트 어때',
    text: '나만의 아늑한 겨울 영화 여행 🧣 ',
    keywordId: '185073',
    startDate: '01-11',
    endDate: '01-31',
    type: 'keyword',
  ...
  {
    title: 'valentine',
    h2Title: '와 함께하는 로맨틱한 2월',
    text: '2월의 마법, 가장 달콤한 순간 🍫 ',
    keywordId: '1326,2343,971',
    startDate: '02-01',
    endDate: '02-28',
    type: 'keyword',
  },
  ...
  {
    title: 'spring',
    h2Title: '와 함께 설레는 새 학기 준비해요',
    text: '새 출발! 설렘 가득 청춘 성장 🎒 ',
    keywordId: '170725,3455,1721',
    startDate: '03-01',
    endDate: '03-31',
    type: 'keyword',
  },
  // 7. 봄/청춘
  {
    ...
    keywordId: '1721,3455,170725,2657,878',
    startDate: '04-01',
    endDate: '04-30',
    type: 'keyword',
  },
  ...
  {
    title: 'family',
    h2Title: '와 함께 마음을 전해요',
    text: '가족의 소중함, 의미 있는 영화 💌 ',
    keywordId: '1416', // Family Reunion (키워드)
  ...
  {
    title: 'classic',
    h2Title: '와 함께 역사의 순간을 기억해요',
    text: '전쟁의 기록, 역사를 만나다 🎖️ ',
    keywordId: '1733,271,456',
    startDate: '06-01',
    endDate: '06-30',
    type: 'keyword',
  },
  // 10. 여름 1
  {
    title: 'vacation',
    h2Title: '와 함께 떠나자!',
    text: '바캉스 필수! 시원한 휴가 무비 ☀️ ',
    keywordId: '4379,3683,2711',
    startDate: '07-01',
    endDate: '07-31',
    type: 'keyword',
  },
  // 11. 호러/미스터리 (장르 ID를 사용)
  {
    title: 'horror',
    h2Title: '와 무더위를 날려버릴!',
    text: '최강 더위! 오싹한 공포 스릴러 😱 ',
    genreId: '27,9648', // Horror, Mystery (장르 ID)
    startDate: '08-01',
    endDate: '08-31',
    type: 'genre',
  },
  ...
  {
    title: 'fall-family',
    h2Title: '와 같이 가족 웃음 꽃 피워요',
    text: '풍요로운 가을, 온 가족이 함께 🍁 ',
    keywordId: '1416,179910', // Family Reunion, Autumn
    startDate: '09-01',
    endDate: '09-30',
    type: 'keyword',
  },
  ...
  {
    title: 'romance',
    h2Title: '와 깊어가는 가을 감성을 맞아해요',
    text: '낙엽처럼 물든 감성 로맨스 🍂 ',
    keywordId: '179910,1331,971',
    startDate: '10-01',
    endDate: '10-20',
    type: 'keyword',
  },
  ...
  {
    title: 'horror',
    h2Title: '와 같이 트릭 오어 트릿!',
    text: '분장 준비! 오싹 짜릿 할로윈 🎃 ',
    keywordId: '479,612,2635',
    startDate: '10-21',
    endDate: '11-05',
    type: 'keyword',
  },
  // 15. 고전 영화 (장르/시대 기준으로 추출)
  {
    ...
    text: '시간을 초월한 명작 고전 🎞️ ',
    keywordId: '378,10703', // Based on Novel, Classic
    // 날짜는 고정하지 않고, API 호출 시 primary_release_year.lte=1980 등을 추가하여 사용 권장
    startDate: '11-06',
    endDate: '11-30',
    type: 'keyword',
  },
