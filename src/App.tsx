...
// //   const shoulHideHeader = hideHeader.includes(location.pathname);
// //   useEffect(() => {
...
//   // Footer를 숨길 페이지 경로들
//   const hideFooterPaths = ['/login', '/signup', '/payment', '/subscription'];
